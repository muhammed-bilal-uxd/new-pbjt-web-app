    ...
    <section className="min-h-screen bg-slate-100 py-4 sm:py-6 lg:py-10 flex items-center justify-center">
      <div className="center-content">
        <div className="w-full overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-black/5">
          <div className="relative overflow-hidden bg-gradient-to-br from-[color:var(--pbjt-primary-color)] via-[color:var(--pbjt-primary-color)] to-[color:var(--pbjt-primary-color)] px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
            ...
            <h1 className="relative mt-5 max-w-4xl text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Building a Better Village Together
            </h1>
          </div>

          <div className="px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
            <p className="max-w-3xl text-xl font-medium leading-relaxed text-slate-600 sm:text-2xl">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex h-28 w-28 items-center justify-center rounded-full border-[1px] border-[color:var(--pbjt-primary-color)] ring-8 ring-white">
                      <Icon className="h-12 w-12 stroke-[1.8] text-[color:var(--pbjt-primary-color)]" />
                    </div>

                    <h3 className="mt-7 text-lg font-bold text-[color:var(--pbjt-primary-color)]">
                      {step.title}
                    </h3>
                    <p className="mt-3 max-w-[14rem] text-base leading-7 text-slate-600">
                      {step.description}
                    </p>
                  </div>
                );
