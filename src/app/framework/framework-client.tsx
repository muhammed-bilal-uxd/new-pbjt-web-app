    ...
    <>
      ...
      <div className={`${styles.hero} center-content`}>
        ...
        <div className={styles.orbitWrap}>
          <Image
            alt="Shared responsibility framework diagram"
            height={1254}
            src="/images/framework/shared-responsibility.png"
            width={1254}
          />
        </div>
      </div>
      ...
      <div className={`${styles.quote} `}>
        <div className={`${styles.quoteText} center-content`}>
          &ldquo; Each tool is designed to support discussion, not compliance.
          &rdquo;
        </div>
      </div>
    </>
