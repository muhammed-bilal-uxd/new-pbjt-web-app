...
export const virudhunagarData: District = {
  ...
  keyInsightsData: {
    name: "Virudhunagar",
    description: [
      "Virudhunagar district, in southern Tamil Nadu, sits at a unique ecological crossroads — where fertile plains meet the hill ecosystems of the Palani and Sirumalai ranges. These landscapes shape the district's climate, water systems, and biodiversity.",
  ...
  village: {
    title: "In Four Villages Across Virudhunagar",
